...
const SetListClient = ({ initialData }: Props) => {
              ...
              <div className="flex items-center gap-2">
                ...
                <label className="inline-flex items-center">
                  <input
                    type="checkbox"
                    className="form-checkbox h-4 w-4 text-blue-600"
                    checked={searchFilters.setName}
                    onChange={(e) => setSearchFilters(prev => ({ ...prev, setName: e.target.checked }))}
                  />
